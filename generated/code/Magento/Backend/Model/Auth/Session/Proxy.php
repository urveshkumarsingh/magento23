...
class Proxy extends \Magento\Backend\Model\Auth\Session implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    ...
    {
        return $this->_getSubject()->setUser($user);
    }
    ...
    {
        return $this->_getSubject()->hasUser();
    }
    ...
    {
        return $this->_getSubject()->unsUser();
    }
    ...
    {
        return $this->_getSubject()->hasAcl();
    }
    ...
    {
        return $this->_getSubject()->unsAcl();
    }
