...
class Interceptor extends \Magento\Backend\Model\Auth\Session implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\Request\Http $request, \Magento\Framework\Session\SidResolverInterface $sidResolver, \Magento\Framework\Session\Config\ConfigInterface $sessionConfig, \Magento\Framework\Session\SaveHandlerInterface $saveHandler, \Magento\Framework\Session\ValidatorInterface $validator, \Magento\Framework\Session\StorageInterface $storage, \Magento\Framework\Stdlib\CookieManagerInterface $cookieManager, \Magento\Framework\Stdlib\Cookie\CookieMetadataFactory $cookieMetadataFactory, \Magento\Framework\App\State $appState, \Magento\Framework\Acl\Builder $aclBuilder, \Magento\Backend\Model\UrlInterface $backendUrl, \Magento\Backend\App\ConfigInterface $config, ?\Magento\Backend\Spi\SessionUserHydratorInterface $userHydrator = null, ?\Magento\Backend\Spi\SessionAclHydratorInterface $aclHydrator = null, ?\Magento\User\Model\UserFactory $userFactory = null, ?\Magento\Framework\AclFactory $aclFactory = null)
    {
        $this->___init();
        parent::__construct($request, $sidResolver, $sessionConfig, $saveHandler, $validator, $storage, $cookieManager, $cookieMetadataFactory, $appState, $aclBuilder, $backendUrl, $config, $userHydrator, $aclHydrator, $userFactory, $aclFactory);
    }
    ...
    public function setUser($user)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('setUser', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasUser');
        if (!$pluginInfo) {
            return parent::hasUser();
        } else {
            return $this->___callPlugins('hasUser', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'unsUser');
        if (!$pluginInfo) {
            return parent::unsUser();
        } else {
            return $this->___callPlugins('unsUser', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getAcl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getAcl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setAcl($acl)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('setAcl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasAcl');
        if (!$pluginInfo) {
            return parent::hasAcl();
        } else {
            return $this->___callPlugins('hasAcl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'unsAcl');
        if (!$pluginInfo) {
            return parent::unsAcl();
        } else {
            return $this->___callPlugins('unsAcl', func_get_args(), $pluginInfo);
        }
    }
